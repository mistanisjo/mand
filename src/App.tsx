            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              {categories.map((category) => {
                ...
                return (
                  <div
                    key={category.id}
                    className={`group relative overflow-hidden rounded-3xl transition-all duration-300 cursor-pointer backdrop-blur-xl bg-white/30 ${category.hoverBg} border border-white/40 hover:border-white/60 hover:shadow-2xl hover:shadow-black/10 ring-1 ring-white/20`}
